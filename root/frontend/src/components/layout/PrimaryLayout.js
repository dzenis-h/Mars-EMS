            ...
            <div className="wrapper">
                <header className="" role="banner">
                    ...
                    <div className="container">
                        <div className="navbar navbar__container">
                            ...
                            <Link to="/login" onClick={this.logout} className="navbar__links">
                                Sign out
                            </Link>
                        </div>
                    </div>
                ...
                <main>
                    <Switch>
                        ...
                        <Route path='/salaries' component={GenerateSalariesContainerComponent}/>
                        <Route exact path='/employees' component={EmployeesContainerComponent}/>
                        <Route path='/employees/:itemId' component={EmployeeProfileContainerComponent}/>
                        <Route exact path='/reports' component={ReportsContainerComponent}/>
                        <Route exact path='/reports/details' component={ReportsDetailsContainerComponent}/>                         
                        <Route path='/reports/details/:itemId' component={EmployeeStatsContainerComponent}/>
                        <Redirect to="/login"/>
                    </Switch>
                </main>
            </div>
