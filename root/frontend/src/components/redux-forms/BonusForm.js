    ...
    render() {
        ...
        return (
            <form onSubmit={handleSubmit(addBonus)}>
                ...
                <div className="form-group">
                    <Field name="isRepeating" className="form__small--check" component="input" type="checkbox" value="isRepeating"/>
                    <label htmlFor="isRepeating" className="form__small--check__label">Is repeating</label>
                </div>
