...
class Home extends React.Component {
    ...
    success = () => toast.info("Penalties successfully saved", { autoClose: 2000 });
    
    openModalToAllowAppUsingSpreadsheetAPI = (url) => {
        confirmAlert({
            title: 'Confirm',
            message: 'Looks like your app is using Google Spreadsheet API. In order to use it, you have to give an access it to your email for the first time',
    ...
    verifyCode = (e) => {
        ...
        SpreadSheetApi.verifyCode(enteredCode).then(res => {
    ...
    render() {
        ...
        const penaltiesList = this.state.penalties.map(item => {
            return <tr key={item.date.toString()}>
                <td className="col-md-4">{item.employee.name} {item.employee.surname}</td>
                ...
                <td><a onClick={this.openDeleteConfirmModal.bind(this, item.employee.jmbg)}><XCircle size="18"/></a></td>
            </tr>
        });
        ...
        return (
            <div className="container">
                ...
                <div className=" col-md-6 validation__wrapper">
                    <h5>Missing API</h5>
                    <p className="">Please validate your google sheets API by entering code in the form below.</p>
                    <br/><br/>
                    <form onSubmit={() => this.verifyCode}>
                            <div className="input-group">
                                <input type="text" className="form-control validation__input" placeholder="Enter a code"
                                       onChange={this.handleInputChange}
                                       value={this.state.code}/>
                                <span className="input-group-btn">
                                    <button className="btn btn-primary" onClick={this.verifyCode}> Submit</button>
                                </span>
                            </div>
                        </form>
                </div>
                            ...
                            <form className="portlet-body">
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="number" className="form-control" id="penaltyValue"
                                           ...
                                           name="amount"
                                           onChange={this.handleValueChange} value={penaltyForm.amount}/>
                                </div>
                                <div className="form-group">
                                ...
                                <div className="form-group">
                                    ...
                                    <textarea type="number" className="form-control" id="penaltyValue"
                                              ...
                                              onChange={this.handleValueChange} value={penaltyForm.description}/>
                                </div>
                                <button type="button" className="btn btn-primary"
                                        onClick={this.addPenalty}>Add penalty
                                </button>
                            </form>
                        </div>
                    </div>
                    <div className="col-md-8">
                        <div className="portlet portlet-boxed">
                            ...
                            <div className="portlet-body no-penalties__wrapper">
                                ...
                                <p className="no-data">There are no penalties added at the moment! <br/>
                            ...
                            <button type="button" className="btn btn-primary" onClick={this.save}>Save all penalties
                            </button>
                            </div>
                     }
                        </div>
