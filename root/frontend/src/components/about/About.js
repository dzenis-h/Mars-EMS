      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-12">
            ...
            <hr />
            <p>
              This app is used for demonstration purposes only. In order to log
              in, you have to sign in with a Google account so they can provide
              you with an API token (Google Spreadsheets API key to be precise),
              but in order not to compromise your own data, the app is
              restricted to one mail which is the following:{" "}
            </p>
            <hr />
            <p>
            ...
            <p>
              ...
              spreadsheets which are public and saved on my Google Drive and
              with which, you'll be able to interact and test the app to it's
              ...
              temporary data of the app. Nothing yours is ever saved and
              remember you're using my Gmail account at the end of the day. {""}{" "}
              😊
            </p>
            <p>
            ...
            <div className="highlightedProject">
              ...
              <div className="description">
                <p>
                  ...
                  [adding a new employee is only a few clicks away, and giving
                  an end date is only a click away]. It contains many other
                  features, like giving loans to employees, tracking their
                  ...
                  to use. It uses ReactJS on the frontend and NodeJS on the
                  backend.
                </p>
              </div>
              <div className="icons">
