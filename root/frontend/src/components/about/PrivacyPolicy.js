  ...
  return (
    <div className="container">
      ...
      <p>
        ...
        <span className="text-info"> https://hr-ems.herokuapp.com</span> website
        (the "Service") operated by Dzenis H. ("I" or "my").
      </p>

      <p>
        This page informs you of the policies regarding the collection, use, and
        disclosure of personal data when you use this Service and the choices
        you have associated with that data.
      </p>

      <p>
        <b>I don't use any of your data</b> to provide or improve the Service.
        If at any time there is a need to collect any type of personal
        information you will be previously informed and if you choose to share
        your personal information using this Service, you consent to the
        collection and use of the information in accordance with these policies.
        ...
        accessible from{" "}
        <span className="text-info">https://hr-ems.herokuapp.com/terms</span>
      </p>
      ...
      <p>
        By default no Perosnal Data is used. While using our Service we may ask
      ...
      <p>
        The Service may also collect information how the Service is accessed and
      ...
      <p>
        ...
        transferred to — or maintained on — computers located outside of your
      ...
      <p>
        I will take all steps reasonably necessary to ensure that your data is
      ...
      <p>
        ...
        storage is 100% secure. While I strive to use commercially acceptable
        means to protect Personal Data, I cannot guarantee its absolute
        security.
      </p>
      ...
      <p>
        If you choose to provide any type of Personal Data, these third parties
        would have access to your Personal Data only to perform these tasks on
      ...
      <p>
        I may update the Privacy Policy from time to time. I will notify you of
