  ...
  return (
    <div className="container">
      ...
      <p>
        ...
        are not owned or controlled by this Service.
      </p>

      <p>
        The service has no control over, and assumes no responsibility for, the
        content, privacy policies, or practices of any third party web sites or
        services. You further acknowledge and agree that Mars-EMS shall not be
      ...
      <p>
        I may terminate or suspend access to the Service immediately, without
      ...
      <p>
        ...
        agreement between us regarding my Service, and supersede and replace any
      ...
      <p>
        ...
        constitutes a material change will be determined at my sole discretion.
      </p>

      <p>
        By continuing to access or use my Service after those revisions become
